...
function MoonIcon({ fill = "black", ...rest }) {
  return (
  ...
  <div style={{display: "flex", paddingLeft:"1%", paddingRight:"1%", margin: "2%", border: "2px solid none", width: "120%", justifyContent:"space-around"}}> 
