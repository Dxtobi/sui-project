...
export default function Login({changeAuth}) {
  ...
  return (
    ...
    <h2 className="font-bold text-[36px] text-center">Welcome Back</h2>
     <p className=" text-center">Great to have you back, let’s continue from where you left off!</p>
    </div>
     ...
     <form className="flex gap-3 flex-col">
      ...
      <button className="w-full text-white bg-call_to_action rounded-full py-3 my-3">Login</button>
     </form> 
